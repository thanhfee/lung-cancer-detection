...
# Thay thế contrib_image bằng tensorflow_addons hoặc tf.image
try:
    import tensorflow_addons as tfa
    contrib_image = tfa.image
except ImportError:
    
    from tensorflow import image as contrib_image
# Trong TF 2.x, các tiện ích training của contrib đã được đưa vào core hoặc keras
from tensorflow.python.training import training as contrib_training
