            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group bg-white rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-indigo-100 transition-all duration-300 overflow-hidden flex flex-col">
                    ...
                    <div class="mt-auto p-4 bg-gray-50/50 border-t border-gray-50 grid grid-cols-4 gap-2">
                        ...
                        <button type="button" 
                                onclick="openGlobalChat({{ $patient->id }})" 
                                class="flex flex-col items-center p-2 hover:bg-white rounded-xl transition-all group/btn" 
                                title="Nhắn tin với AI">
                            <svg class="w-5 h-5 text-gray-400 group-hover/btn:text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
